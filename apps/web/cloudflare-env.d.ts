/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: e599de7f8f927d7f65199eed8bf6badd)
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        'NEXT_PUBLIC_SITE_URL' | 'NEXTJS_ENV' | 'GITHUB_CLIENT_ID' | 'GITHUB_CLIENT_SECRET' | 'BETTER_AUTH_SECRET'
      >
    > {}
}
