/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: bd275919325e70196ec2a375cb0eba0a)
// Runtime types generated with workerd@1.20251210.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		NEXT_PUBLIC_SITE_URL: "https://yooka.com";
		NEXT_PUBLIC_R2_BUCKET_URL: "https://i.yooka.me";
		NEXTJS_ENV: string;
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
		BETTER_AUTH_SECRET: string;
		YOOKA_BUCKET: R2Bucket;
		DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* yooka-web */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_R2_BUCKET_URL" | "NEXTJS_ENV" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "BETTER_AUTH_SECRET">> {}
}
