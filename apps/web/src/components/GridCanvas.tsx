...
const GridItemContent: React.FC<{ item: GridItem }> = ({ item }) => {
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm p-4 overflow-hidden relative h-full w-full select-none flex flex-col">
      {item.type === 'text' && (
