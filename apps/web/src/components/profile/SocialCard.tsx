...
export const SocialCard: React.FC<SocialCardProps> = ({ item, onClick, editable = false }) => {
  ...
  const CardContent = () => (
    <div
      className={`h-full w-full ${config.bgColor} rounded-xl p-4 flex flex-col items-center justify-center gap-3 shadow-sm hover:shadow-md transition-all duration-200 ${editable ? 'cursor-pointer' : ''}`}>
      {/* 图标 */}
