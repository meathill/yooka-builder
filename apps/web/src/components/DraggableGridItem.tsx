  ...
  return (
    ...
    >
      ...
      {!readOnly && (
        <>
            <div 
                className="absolute bottom-1 right-1 w-4 h-4 cursor-se-resize opacity-0 group-hover:opacity-100 transition-opacity bg-white dark:bg-gray-700 border border-gray-400 rounded-sm z-20 flex items-center justify-center"
            ...
            >
             ...
             <div 
                className="absolute bottom-1 left-1 w-4 h-4 cursor-sw-resize opacity-0 group-hover:opacity-100 transition-opacity bg-white dark:bg-gray-700 border border-gray-400 rounded-sm z-20"
                onPointerDown={(e) => handleResizeStart(e, 'sw')}
            />
             <div 
                className="absolute top-1 right-1 w-4 h-4 cursor-ne-resize opacity-0 group-hover:opacity-100 transition-opacity bg-white dark:bg-gray-700 border border-gray-400 rounded-sm z-20"
                onPointerDown={(e) => handleResizeStart(e, 'ne')}
            />
             <div 
                className="absolute top-1 left-1 w-4 h-4 cursor-nw-resize opacity-0 group-hover:opacity-100 transition-opacity bg-white dark:bg-gray-700 border border-gray-400 rounded-sm z-20"
