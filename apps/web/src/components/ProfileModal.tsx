...
export const ProfileModal: React.FC<ProfileModalProps> = ({ isOpen, onClose, currentUsername, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-2xl p-6 w-full max-w-md relative animate-in fade-in zoom-in duration-200">
        <button
          onClick={onClose}
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-6">Manage your public profile identity.</p>
          ...
          <div className="mb-4">
            ...
            <div className="relative rounded-md shadow-sm">
              ...
              <input
                type="text"
                id="username"
                className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-24 sm:text-sm border-zinc-300 rounded-md p-2 dark:bg-zinc-900 dark:border-zinc-700 dark:text-white"
            ...
            <p className="mt-1 text-xs text-zinc-500">Minimum 5 characters. Letters, numbers, and hyphens only.</p>
          </div>
